...
export { Counter } from "@automerge/automerge/slim";
export type { Doc, Heads, Patch, PatchCallback, Prop, ActorId, Change, ChangeFn, } from "@automerge/automerge/slim";
export { getChanges, getAllChanges, applyChanges, view, getConflicts, } from "@automerge/automerge/slim";
export { insertAt, deleteAt, } from "@automerge/automerge/slim";
